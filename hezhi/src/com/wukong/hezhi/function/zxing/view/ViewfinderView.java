...
package com.wukong.hezhi.function.zxing.view;
...
public final class ViewfinderView extends View {
     ...
     * 扫描框下方提示
     */
    public String text = "将二维码放入框内, 即可自动扫描";
...
//        resultPointColor = resources.getColor(R.color.possible_result_points);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            // 画扫描框边上的角，总共8个部分
            paint.setColor(getContext().getResources().getColor(com.wukong.hezhi.R.color.base));
            ...
            canvas.drawText(text,
                    (frame.right-frame.left)/2 + frame.left - rect.width()/2,

 ...
 * @Description: TODO(评价中心---待评价)
 * @author HuangFeiFei
 * @date 2017-12-19
 *
 */
public class AppraiseBeingFragment extends NoPreloadFragment {
    ...
    protected void init() {
    	empty.setText(ContextUtil.getString(R.string.appraise_being_isnull));
        initView();
        setListener();
    }
    ...
    public void updateState(Class notifyTo, Object notifyFrom, Object msg) {
        ...
        if (notifyTo.equals(getClass())) {
            if (notifyFrom.equals(AppraiseShowActivity.class)) {  //订单取消通知
                try {
                	int id = (int)msg;
                	LogUtil.i(id+"");

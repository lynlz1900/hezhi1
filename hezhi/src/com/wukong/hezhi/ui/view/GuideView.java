...
public class GuideView extends RelativeLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private void showHint() {
        ...
        this.setBackgroundResource(R.color.transparency);
...
//            return (int) (Math.sqrt(x * x + y * y) / 2);
    ...
    private void drawBackground(Canvas canvas) {
        ...
        if (backgroundColor != 0) {
            bgPaint.setColor(backgroundColor);
        	 ...
        	 bgPaint.setColor(getContext().getResources().getColor(R.color.bg_transparency_black));
        }
    ...
    public static class Builder {
        Context mContext;
        private List<GuideView> viewList = new ArrayList<GuideView>();
        ...
        public Builder addHintView(View targetView, String hintText, Direction dir, MyShape shape, int xOffset, int yOffset) {
            RelativeLayout rv = (RelativeLayout) LayoutInflater.from(mContext).inflate(R.layout.layout_guide_iknown, null);

 ...
 * 
 */
public class KDNiaoInfoAdapter extends BaseAdapter {

	private Activity mActivity;
	// private KDNiaoInfo kdNiaoInfo;
	private ListView lv;

	private List<Traces> traces;

	public KDNiaoInfoAdapter(List<Traces> traces, ListView lv, Activity mActivity) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		ViewHolder holder;
		if (convertView == null) {
			convertView = ScreenUtil.inflate(R.layout.item_list_express);
